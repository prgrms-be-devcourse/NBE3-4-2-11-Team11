...
public class NoticeAdminController {
    ...
    @PostMapping("/notice")
    public ResponseEntity<RsData<NoticeCreateResponse>> createNotice(@Valid @RequestBody NoticeCreateRequest noticeCreateRequest, @AuthenticationPrincipal Admin admin) {
    ...
    public ResponseEntity<RsData<NoticeUpdateResponse>> updateNotice(@PathVariable("id") Long id, @Valid @RequestBody NoticeUpdateRequest noticeUpdateRequest, @AuthenticationPrincipal Admin admin) {
    ...
    public ResponseEntity<RsData<Void>> deleteNotice(@PathVariable("id") Long id, @AuthenticationPrincipal Admin admin) {
