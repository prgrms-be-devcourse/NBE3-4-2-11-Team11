...
//       <section className="w-full max-w-full mx-auto grid grid-cols-1 md:grid-cols-2 gap-24 items-center justify-start p-8 mt-32 pt-16 mb-32">
//         {/* 왼쪽 텍스트 (더 왼쪽으로 이동: pl-60) */}
//         <div className="pl-65 max-w-lg self-start">
//           <h1 className="text-5xl font-bold text-black mb-4">POFO</h1>
//           <p className="text-2xl font-semibold text-gray-800">
//             개발자의 지식과 경험을 한 곳에<br />
//             당신만의 아카이브
//           </p>
...
//             {/* 두 번째 섹션 (왼쪽으로 이동) */}
//             <section className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-24 items-center p-8 mb-32 ml-64">
//         {/* 왼쪽 이미지 */}
//         <div className="flex justify-start w-full max-w-lg h-[450px] overflow-hidden rounded-lg shadow-lg">
//           <Image
...
//       {/* 세 번째 섹션 */}
//       <section className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-24 items-center p-8 mb-32">
//         {/* 왼쪽 텍스트 */}
//         <div>
...
//         {/* 세 번째 이미지 */}
//         <div className="flex justify-center w-[530px] h-[380px] overflow-hidden rounded-lg shadow-lg">
//           <Image
